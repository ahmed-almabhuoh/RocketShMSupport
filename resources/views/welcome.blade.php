...
<body id="kt_body" class="header-mobile-fixed aside-enabled aside-fixed aside-secondary-enabled page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <!--end::Aside-->
            <!--begin::Wrapper-->
            <div class="d-flex flex-column flex-row-fluid wrapper" style="padding-left: 20px !important;" id="kt_wrapper">
    ...
    <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
        ...
        <li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
            <a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary"
                href="https://preview.keenthemes.com/metronic/demo3/builder.html" target="_blank">
                <i class="flaticon2-gear"></i>
            </a>
        </li>
        <!--end::Item-->
